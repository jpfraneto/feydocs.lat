import{u as r,j as s}from"./index-B_EWvgIS.js";const a={title:"Getting Started",description:"undefined"};function i(n){const e={a:"a",aside:"aside",code:"code",div:"div",h1:"h1",h2:"h2",h3:"h3",header:"header",hr:"hr",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...r(),...n.components};return s.jsxs(s.Fragment,{children:[s.jsx(e.header,{children:s.jsxs(e.h1,{id:"getting-started",children:["Getting Started",s.jsx(e.a,{"aria-hidden":"true",tabIndex:"-1",href:"#getting-started",children:s.jsx(e.div,{"data-autolink-icon":!0})})]})}),`
...
`,s.jsxs(e.aside,{"data-callout":"warning",children:[s.jsx(e.strong,{"data-callout-title":!0,children:"Staking Contract Coming"}),s.jsx(e.p,{children:"The staking contract is still being finalized. For now, hold $FEY tokens in your wallet. Staking will be enabled in a future protocol update."})]}),`
`,s.jsx(e.p,{children:"Staking will provide:"}),`
`,s.jsxs(e.ul,{children:[`
...
`,s.jsx(e.p,{children:"Once staking is live, you can:"}),`
`,s.jsxs(e.ul,{children:[`
`,s.jsx(e.li,{children:"Check rewards through the Fee Locker contract"}),`
`,s.jsx(e.li,{children:"Claim accumulated fees manually"}),`
`,s.jsx(e.li,{children:"View real-time protocol activity"}),`
`]}),`
...
`]}),`
`,s.jsx(e.hr,{}),`
`,s.jsxs(e.p,{children:["Ready to dive deeper? Explore the ",s.jsx(e.a,{href:"/architecture/overview",children:"Protocol Architecture →"})," or check out specific ",s.jsx(e.a,{href:"/contracts/factory",children:"Contract Documentation →"}),"."]})]})}function d(n={}){const{wrapper:e}={...r(),...n.components};return e?s.jsx(e,{...n,children:s.jsx(i,{...n})}):i(n)}export{d as default,a as frontmatter};
